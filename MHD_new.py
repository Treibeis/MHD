...
def locus():
	...
	print('locus_s2(lam, t, x0, xm, l, d = {}, n, k = 0, f = 1, mindx, m0)\n')
...
def locus_s2(lam, t, x0, xm, l, d = {}, n = 0, k = 0, f = 1, mindx = 1.0/10**5, m0 = 10000):
	...
	if t==-1:
		for i in range(n+1):
			...
			if f==1:
				...
				ld.append(connect(do_,do,1))
		dl = {'v':lv, 'a':la, 'x':ls, 'm':m, 'n':n+1, 'd':ld, 's1':lv_a_s1, 's2':lv_a_s2, 't':lt}
		return dl
	if (t==2)or(t==3):
		for i in range(n+1):
			m = m0
			...
			if f==1:
				...
				ld.append(connect(do_,do,1))
		dl = {'v':lv, 'a':la, 'x':ls, 'm':lm, 'dx':ldx, 'n':n+1, 'd':ld, 's1':lv_a_s1, 's2':lv_a_s2, 't':lt}
		return dl
	for i in range(n+1):
		m = m0
		A = begin(lam, t, x0, d)
